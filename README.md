...
| `rubyAssignmentNewline` | `--ruby-assignment-newline` |  `true`  | When true, adds a newline and indentation after assignment when the right-hand side is multiple lines and not a literal.             |
